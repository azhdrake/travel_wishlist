...
class TestViewHomePageIsEmptyList(TestCase):
    ...
    def test_load_visted_page_shows_empty_list(self):
        response = self.client.get(reverse('visited')) # modified name to match my naming scheme.
        self.assertTemplateUsed(response, 'travel_wishlist/visited.html')
        self.assertEquals(0, len(response.context['places'])) # changed 'visited' to 'places' to match how I named things
...
class TestWishList(TestCase):
    ...
    def test_view_wishlist(self):
        ...
        data_rendered = list(response.context['places']) # changed 'visited' to 'places' to match how I named things
...
class TestPlaceDetail(TestCase):
    ...
    def test_place_detail(self):
        ...
        # Check correct template was used
        self.assertTemplateUsed(response, 'travel_wishlist/place_details.html') # modified file name to match my naming scheme.
    ...
    def test_upload_new_image_for_own_place(self):
        ...
        with self.settings(MEDIA_ROOT=self.MEDIA_ROOT):
            ...
            with open(img_file_path, 'rb') as img_file:
                ...
                expected_uploaded_file_path = os.path.join(self.MEDIA_ROOT, 'user_umages', img_file_name) #modified file name to match my typo
